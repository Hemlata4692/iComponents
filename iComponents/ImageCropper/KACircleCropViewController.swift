...
//                scrollView.zoomScale = scaleWidth
    ...
    func setLabelAndButtonFrames() {
        ...
        okButton.frame.origin = CGPoint(x: cutterView.frame.size.width/2 + view.frame.size.width/2 - okButton.frame.size.width - 12, y: cutterView.frame.size.height/2 - view.frame.size.height/2 + (screen.height - 50))

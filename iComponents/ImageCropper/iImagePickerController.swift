...
open class iImagePickerController : UIViewController,UIImagePickerControllerDelegate,UINavigationControllerDelegate,KACircleCropViewControllerDelegate{
    ...
    open func loadImagePicker(cameraAccess: Bool = true, galleryAccess: Bool = true, ovalCrop:Bool = true, cropSize: CGSize = CGSize(width: 1.0, height: 1.0), selectMessage:String) {
    ...
    // *****
    open func iImagePickerController(_ imagePicker: iImagePickerController!, croppedImage: UIImage!) {
